...
SVGElement.prototype = {
	...
	init: function (renderer, nodeName) {
		...
		/**
		 * A controller of attribute setters. These methods, if defined, are called right before a certain
...
SVGRenderer.prototype = {
	...
	/**
	 * An extendable controller of functions for defining symbol paths.
	 */
	symbols: {
...
Axis.prototype = {
	...
	/**
	 * Set the max ticks of either the x and y axis controller
	 */
...
Series.prototype = {
	...
	getAttribs: function () {
		...
		while (i--) {
			...
			// create it's own attribute controller
